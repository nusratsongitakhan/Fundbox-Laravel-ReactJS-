...
const CreateAdminEvent = () => {
    ...
    const addEvent = async (e) => {
        ...
        const res = await axios.post('http://localhost:8000/api/admin/createAdminEvent', 
        { 
            event_name: event_name,event_details: event_details,event_category: event_category,event_amount: event_amount,date : date,event_phone : event_phone,status:status
        },{
            headers: { 
